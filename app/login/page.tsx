    ...
    <div className="min-h-screen bg-black flex flex-col max-w-md mx-auto">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-8 pt-16 pb-8">
        ...
        <div className="mb-10 flex flex-col items-center gap-3">
          ...
          <h1 className="text-white text-3xl font-bold tracking-tight">Spotify</h1>
        </div>
        ...
        <p className="text-white/50 text-sm text-center mb-8">
          para continuar escuchando música
        </p>
        ...
        <form onSubmit={handleLogin} className="w-full flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              required
              className="w-full bg-[#282828] text-white placeholder-white/25 px-4 py-3.5 rounded-lg text-sm outline-none focus:ring-2 focus:ring-[#1DB954] transition border border-transparent focus:border-transparent"
            />
          </div>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative">
              <input
                ...
                required
                className="w-full bg-[#282828] text-white placeholder-white/25 px-4 py-3.5 pr-12 rounded-lg text-sm outline-none focus:ring-2 focus:ring-[#1DB954] transition border border-transparent"
              />
              <button
                type="button"
          ...
          <button
            type="submit"
            className="w-full bg-[#1DB954] text-black font-bold py-4 rounded-full text-sm hover:bg-[#1ed760] active:scale-[0.98] transition mt-2"
          >
            Iniciar sesión
          </button>
        </form>
      ...
      <div className="px-8 pb-10 text-center">
        <p className="text-white/20 text-xs">
          Al continuar, aceptas los Términos y condiciones de uso de Spotify.
        </p>
      </div>
    </div>
  );
